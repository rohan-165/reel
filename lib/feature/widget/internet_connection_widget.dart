...
class InternetConnectionMsgWidget extends StatelessWidget {
  ...
  const InternetConnectionMsgWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        vertical: Platform.isIOS ? 15.h : 3.h,
      ),
...
class _NoInternetConnectionWidgetState
  ...
  final ValueNotifier<bool> _isToHide =
      ValueNotifier<bool>(getIt<InternetCubit>().state.isOnline);
